...
export const Section1 = () => {
    ...
    return (
        <section
            className='flex flex-col md:flex-row items-center md:items-start justify-evenly px-8   tracking-wider min-h-screen'

        >
            <div
                className={`self-center md:w-1/2 text-center md:text-left mb-12 md:mb-0 transition-all duration-700 ease-out ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-4"}`}
                ref={ref}
            >
